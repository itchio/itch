...
```go
const electronVersion = "44.1.0"  // Must match package.json electron version
const chromeDriverVersionString = "ChromeDriver 152.0.7977.65"  // Chrome version for that Electron
```
