...
```go
const electronVersion = "43.0.0"  // Must match package.json electron version
const chromeDriverVersionString = "ChromeDriver 150.0.7871.46"  // Chrome version for that Electron
```
