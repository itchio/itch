...
declare namespace _ {
  ...
  interface UnderscoreStatic {
     ...
     * @return The elements within `list` that contain the required `properties`.
     **/
    where<T, U extends {}>(list: _.Dictionary<T>, properties: U): T[];
     ...
     * @return The first element in `list` that has all `properties`.
     **/
    findWhere<T, U extends {}>(list: _.Dictionary<T>, properties: U): T;
     ...
     * @return The list of elements within `list` that have the property `propertyName`.
     **/
    pluck<T extends {}>(list: _.Dictionary<T>, propertyName: string): any[];
     ...
     * @param iterator Sort iterator for each element within `list`.
     **/
    sortBy<T>(list: _.Dictionary<T>, iterator: string, context?: any): T[];
  ...
  interface _Chain<T> {
     ...
     **/
    findKey(
      predicate: _.ObjectIterator<any, boolean>,
      context?: any
    ): _Chain<T>;
