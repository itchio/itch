...
export namespace capsule.messages {
  export class Packet {
    ...
    messageType(): capsule.messages.Message {
      ...
      return offset /** @type {capsule.messages.Message} */
        ? this.bb.readUint8(this.bb_pos + offset)
        : capsule.messages.Message.NONE;
    }
...
export namespace capsule.messages {
  export class HotkeyPressed {
    ...
    static getRootAsHotkeyPressed(
      ...
      return (obj || new HotkeyPressed()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      );
    }
...
export namespace capsule.messages {
  export class CaptureStart {
    ...
    static getRootAsCaptureStart(
      ...
      return (obj || new CaptureStart()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      );
    }
...
export namespace capsule.messages {
  export class CaptureStop {
    ...
    static getRootAsCaptureStop(
      ...
      return (obj || new CaptureStop()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      );
    }
...
export namespace capsule.messages {
  export class VideoSetup {
    ...
    static getRootAsVideoSetup(
      ...
      return (obj || new VideoSetup()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      );
    }
    ...
    pixFmt(): capsule.messages.PixFmt {
      var offset = this.bb.__offset(this.bb_pos, 8);
      return offset /** @type {capsule.messages.PixFmt} */
        ? this.bb.readInt32(this.bb_pos + offset)
        : capsule.messages.PixFmt.UNKNOWN;
    }
    ...
    shmem(obj?: capsule.messages.Shmem): capsule.messages.Shmem {
      ...
      return offset
        ? (obj || new capsule.messages.Shmem()).__init(
...
export namespace capsule.messages {
  export class VideoFrameCommitted {
    ...
    static getRootAsVideoFrameCommitted(
      ...
      return (obj || new VideoFrameCommitted()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      );
    }
...
export namespace capsule.messages {
  export class VideoFrameProcessed {
    ...
    static getRootAsVideoFrameProcessed(
      ...
      return (obj || new VideoFrameProcessed()).__init(
        bb.readInt32(bb.position()) + bb.position(),
        bb
      );
    }
