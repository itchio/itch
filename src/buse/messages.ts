...
// Generated on Mar  1 11:09:28 against 561da459820391cdc2c40af3d4172ff2a838db2e
 ...
 */
export const SessionList = createRequest<SessionListParams, SessionListResult>(
  "Session.List"
);
...
/**
 * Result for Session.LoginWithPassword
 */
export interface SessionLoginWithPasswordResult {
 ...
 */
export const SessionLoginWithPassword = createRequest<
  SessionLoginWithPasswordParams,
  SessionLoginWithPasswordResult
>("Session.LoginWithPassword");

/**
 * Result for Session.RequestCaptcha
 */
export interface SessionRequestCaptchaResult {
 ...
 * conditions are met.
 */
export const SessionRequestCaptcha = createRequest<
  SessionRequestCaptchaParams,
  SessionRequestCaptchaResult
>("Session.RequestCaptcha");

/**
 * Result for Session.RequestTOTP
 */
export interface SessionRequestTOTPResult {
 ...
 */
export const SessionRequestTOTP = createRequest<
  SessionRequestTOTPParams,
  SessionRequestTOTPResult
>("Session.RequestTOTP");

/**
 * Result for Session.UseSavedLogin
 */
export interface SessionUseSavedLoginResult {
 ...
 */
export const SessionUseSavedLogin = createRequest<
  SessionUseSavedLoginParams,
  SessionUseSavedLoginResult
>("Session.UseSavedLogin");

/**
 * Result for Session.Forget
 */
 ...
 */
export const SessionForget = createRequest<
  SessionForgetParams,
  SessionForgetResult
>("Session.Forget");
...
/**
 * Result for Fetch.MyCollections
 */
export interface FetchMyCollectionsResult {
  // no fields
}
 ...
 * undocumented
 */
export const FetchMyCollections = createRequest<
  FetchMyCollectionsParams,
  FetchMyCollectionsResult
>("Fetch.MyCollections");
...
/**
 * Params for Session.LoginWithPassword
 */
export interface SessionLoginWithPasswordParams {
...
/**
 * Params for Session.RequestCaptcha
 */
export interface SessionRequestCaptchaParams {
  /** Address of page containing a recaptcha widget */
  recaptchaUrl: string;
}

/**
 * Params for Session.RequestTOTP
 */
export interface SessionRequestTOTPParams {
  // no fields
}

/**
 * Params for Session.UseSavedLogin
 */
export interface SessionUseSavedLoginParams {
  /** undocumented */
  sessionId: number;
}

/**
 * Params for Session.Forget
 */
export interface SessionForgetParams {
  /** undocumented */
  sessionId: number;
}
...
/**
 * Payload for Fetch.Collection.YieldGames
 */
export interface FetchCollectionYieldGamesNotification {
  /** undocumented */
  offset: number;
  /** undocumented */
  total: number;
 ...
 */
export const FetchCollectionYieldGames = createNotification<
  FetchCollectionYieldGamesNotification
>("Fetch.Collection.YieldGames");
...
/**
 * Params for Fetch.MyCollections
 */
export interface FetchMyCollectionsParams {
  /** Credentials to use for fetching */
  credentials: FetchCredentials;
}

/**
 * Payload for Fetch.MyCollections.Yield
 */
export interface FetchMyCollectionsYieldNotification {
  /** undocumented */
  offset: number;
  /** undocumented */
  total: number;
 ...
 * available.
 */
export const FetchMyCollectionsYield = createNotification<
  FetchMyCollectionsYieldNotification
>("Fetch.MyCollections.Yield");
