...
async function add_install_location_request () {
  ...
  let dialog_opts = {
    title: i18n.t('prompt.add_install_location.title'),
...
async function remove_install_location_request (payload) {
  ...
  if (loc.item_count > 0) {
    ...
    let dialog_opts = {
      title: i18n.t('prompt.remove_install_location.title'),
      message: i18n.t('prompt.remove_install_location.message'),
      detail: i18n.t('prompt.remove_install_location.detail', {location: loc.path}),
      buttons
    }
